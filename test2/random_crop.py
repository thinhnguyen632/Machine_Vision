...
path = "C:/Users/Welcome/Documents/opencv/test2/frame_vid2"
save_path = "C:/Users/Welcome/Documents/opencv/test2/frame_vid2_cropped/n"
...
for file in listdir(path):
    if file!='.DS_Store':
        ...
        # Luu hinh anh
        cv.imwrite(save_path + '/cropped_2_' + str(i) + '.jpg', crop_img)
        i = i + 1
